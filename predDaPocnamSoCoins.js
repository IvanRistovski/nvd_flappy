window.onload = function() {
        ...
        allPlayersRef.on("value", (snapshot) => {
            ...
            if (players[playerId]) {
                ...
                birdImg.onload = function() {
                    if (birdImg.complete) {
                        // canvasContainer.style.display = "block"; // Show the canvas container    PRAZNO, RADI TOA SHTO SAKAM DA E NA KEY PRESS
    ...
    function setupFlappyBirdGame(color) {
        ...
        birdImg.onload = function() {
           // context.drawImage(birdImg, bird.x, bird.y, bird.width, bird.height); PRAZNO PAK RADI ISTOTO #2
        };
        ...
        bottomPipeImg.src = "assets/flappy-botpipe-gray.png";
         ...
         requestAnimationFrame(update); //PRAZNO ISTOTO #3
         ...
         let imagesLoaded = 0;
         const totalImages = 3; // birdImg, topPipeImg, bottomPipeImg
    ...
    function moveBird(e) {
        if (e.code == "Space" || e.code == "ArrowUp" || e.code == "KeyX") {
            ...
            if (gameOver && gameStarted) {
                ...
                score = 0;
                gameOver = false;
                showStartMessage(); // Show start message again
            }
        }
    }
