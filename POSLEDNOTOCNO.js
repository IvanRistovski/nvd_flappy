//AKO BOJATA NA NEKOJ PLAYER E X, TOGASH OVOJ PRESET -> -120,240 itn
window.onload = function() {
    ...
    //const canvasContainer = document.querySelector(".canvas-container"); // Add a container for the canvas
    ...
    function hasPlayerWithColors(colors) {
        return Object.values(players).some(player => colors.includes(player.color));
    }
    // const colorsToCheck = ["red", "blue", "yellow", "green"];
    
    // if (hasPlayerWithColors(colorsToCheck)) {
    //     console.log("There is a player with one of the colors red, blue, yellow, or green.");
    // } else {
    //     console.log("No player has the color red, blue, yellow, or green.");
    // }
